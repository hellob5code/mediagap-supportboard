...
switch ($_POST['function']) {
    ...
    case 'assign-conversations-from-agent-to-agent':
        die(sb_json_response(sb_assign_conversations_from_agent_to_agent($_POST['from_agent_id'], $_POST['to_agent_id'])));
    case 'queue':
